...
void generate_grain(audio_grain_t *grain) {
    ...
    grain->total_duration = 1 + (rand() % 1000);
    ...
    if (rand() % 100 < 30) grain->effects_mask |= 0x01;
    if (rand() % 100 < 30) grain->effects_mask |= 0x02;
    if (rand() % 100 < 20) grain->effects_mask |= 0x04;
    if (rand() % 100 < 20) grain->effects_mask |= 0x08;
}
